  <?php foreach ($userTechStrength as $key => $techStrength) { ?>
    ...
    <form class="form-horizontal" onSubmit="return (validateUpdateTechStrength(<?= $techStrength->getId() ?>));">
  ...
  <form id= "tech_strength_form" class="form-horizontal" onSubmit="return (validateUpdateTechStrength());">
