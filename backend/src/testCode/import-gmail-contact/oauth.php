...
<br/>
	    <div><b>Visit Tutorial: </b><a style="font-size:17px;" href="http://25labs.com/import-gmail-or-google-contacts-using-google-contacts-data-api-3-0-and-oauth-2-0-in-php/" >Import Gmail or Google contacts using Google Contacts Data API 3.0 and OAuth 2.0 in PHP</a></div>
	        <br/>
            <div align="center" >
            <a  style="font-size:25px;font-weight:bold;" href="https://accounts.google.com/o/oauth2/auth?client_id=144552641015-toiemq4funembdap9uiqmapeace48sfj.apps.googleusercontent.com&redirect_uri=http://www.collap.com/google/result.php&scope=https://www.google.com/m8/feeds/&response_type=code">Click here to Import Gmail Contacts</a>
        </div>
        <div style="padding-left: 50px;">
<?php
$client_id = '144552641015-toiemq4funembdap9uiqmapeace48sfj.apps.googleusercontent.com';
$client_secret = 'puZDmvb-g7a6HPCz-LfbLiMO';
$redirect_uri = 'http://www.collap.com/google/result.php';
$max_results = 200;
