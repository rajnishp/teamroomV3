<?php
	...
	for ($user_id = 7 ; $user_id < 200; $user_id++) {
		
		$get_User_Info = mysqli_query($dbHandle_old, "SELECT * FROM user_info WHERE user_id = '$user_id';");
		
		$get_About_User = mysqli_query($dbHandle_old, "SELECT * FROM about_users WHERE user_id = '$user_id';");
