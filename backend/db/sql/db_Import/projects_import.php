<?php
	...
	for ($pr_id = 1 ; $pr_id < 72; $pr_id++) {
		
		$get_Projects = mysqli_query($dbHandle_old, "SELECT * FROM projects WHERE project_id = '$pr_id';");
		
		$get_Pr_Funding = mysqli_query($dbHandle_old, "SELECT * FROM project_funding_info WHERE project_id = '$pr_id';");
